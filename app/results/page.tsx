...
export default function ResultsPage() {
  ...
  useEffect(() => {
    ...
    setHasPassed(parsedResults.score >= 50);
  }, [router]);
  ...
  const scoreColor = results.score >= 50 ? 'var(--success-color)' : 'var(--danger-color)';
  const scoreEmoji = results.score >= 50 ? '✅' : '❌';
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ 
            ...
            {hasPassed 
              ...
              : 'Vous n\'avez pas atteint le score minimum de 50%. Vous pouvez recommencer.'}
          </p>
          <div style={{ 
            background: '#f3f4f6', 
            padding: '1.5rem', 
        ...
        <div style={{ 
          ...
          {!hasPassed && (
            <p style={{ 
              ...
              Vous devez obtenir au moins 50% pour passer. Vous pouvez recommencer le test.
            </p>
          )}
          <button 
